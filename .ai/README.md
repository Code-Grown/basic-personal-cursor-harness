...
├── harness/          session-gate, safety-rails, read-budget, quality-bars, confirm-execute, repo-pointer, tech-skills, model-routing, crystallize, promote-harness, triggers, checks, rollback
