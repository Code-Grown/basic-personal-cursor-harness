...
Versión 2.6.7 · Context-discipline · Crystallize · AI product models · Close-versioning → push main
...
├── harness/          session-gate, safety-rails, read-budget, quality-bars, confirm-execute, change-strategy, context-discipline, ai-product-models, close-versioning, repo-pointer, tech-skills, model-routing, crystallize, promote-harness, triggers, checks, rollback
