...
Versión 2.6.18 · model-routing sin pin de versión → push main
...
├── harness/          session-gate, safety-rails, read-budget, quality-bars, confirm-execute, change-strategy, line-continuity, deploy-parity, context-discipline, ux-flow-first, ux-craft, ia-first, gap-fill, vue-pug, ai-product-models, close-versioning, repo-pointer, tech-skills, model-routing, crystallize, promote-harness, triggers, checks, rollback
