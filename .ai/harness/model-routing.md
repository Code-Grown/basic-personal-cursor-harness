...
- Recommend the current strong chat model (Grok when that is the picker). Do not pin a version in the harness.
...
6. Do not hardcode a model slug. Tasks inherit. A pinned slug goes stale and the Task call fails.
